...
<%
	...
	String query = "select t.category_ID, c.title, t.amount, t.year from winetrade as t natural join winecategory as c where t.amount=(select max(amount) from winetrade where year=t.year) order by year desc;";
