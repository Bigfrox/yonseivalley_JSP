...
%>
	...
	<form action = 'update_winery_trade.jsp' method = 'post'>
		<div>
		<label>WT ID</label> <input name ="WT_ID" type="text" value="<%=WT_ID%>" readonly/>
		</div>
		<div>
